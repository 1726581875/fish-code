...
public enum AgentMode {
    ...
    PLAN("plan", "\u001B[36m", "规划",
            ...
            "规则：\n" +
            "- 只能使用 read_file、find_file 和 search_text。\n" +
            ...
            new HashSet<>(Arrays.asList("read_file", "find_file", "search_text"))),
    ...
    AUTO("auto", "\u001B[32m", "自动执行",
            ...
            new HashSet<>(Arrays.asList("read_file", "find_file", "search_text", "edit_file", "write_file", "run_command"))),
